  ...
  projects = [
    {
      ...
      partner: '한국연구재단',
      title: '설명/예측/최적화 가능한 AI기반 스마트 제조 플랫폼',
      contents: [
        {
          title: '[Explainable AI] 자가 진단 및 개선을 위한 지능형 제조 환경 구축',
          contents: [
        ...
        {
          title: '[Predictable AI] 다양한 환경에 적용 가능한 반응형 예측 시스템 구축',
          contents: [
        ...
        {
          title: '[Optimizable AI] 제조 효율성 향상을 위한 최적화 기반 제조 공정 제어',
          contents: [
    ...
    {
      img: 'assets/img/projects/31.png',
      term: '2019.03 ~ 2022.02',
      partner: '한국산업기술진흥원',
      title: '산업인공지능 전문인력양성사업',
      contents: [
        {
          contents: [
            '산업인공지능 핵심기술 R&D 능력과 산업별 도메인 지식을 갖춘 전문인력 양성',
            '제조산업과 AI를 융합한 교육과정 설계 및 주관 – 참여기관의 유기적인 협력을 통해 글로벌 수준의 산업인공지능 리더 양성',
            '산업 AI 플랫폼 구축을 통해 국내외 기업/기관의 데이터 연계 문제 해결형 인력 양성',
          ]
        },
      ]
    },
